...
Route::middleware('jaze.auth')->prefix('jaze')->group(function (): void {
...
Route::middleware('jaze.auth')->get('v1/get_logofftime_onlinestatus/{userId}', [JazeApiController::class, 'userLogoffTimeOnlineStatus']);
